    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="header-section" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; gap: 15px; flex-wrap: wrap;">
                ...
                <!-- Tombol Tambah Data -->
                <a href="{{ route('produk1.create') }}" class="btn btn-edit" style="background-color: #0ea5e9; border-color: #0ea5e9; display: inline-flex; align-items: center; gap: 8px; text-decoration: none;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="width: 80px; height: 80px; border-radius: 8px; overflow: hidden; border: 1px solid #e2e8f0; display: flex; align-items: center; justify-content: center; background-color: #f8fafc;">
                                    <img src="{{ asset($item->gambar) }}" alt="Gambar Produk" style="width: 100%; height: 100%; object-fit: cover;">
                                </div>
                            </td>

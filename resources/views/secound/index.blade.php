    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="header-section" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; gap: 15px; flex-wrap: wrap;">
                ...
                <!-- Tombol Tambah Data -->
                <a href="{{ route('secound.create') }}" class="btn btn-edit" style="background-color: #0ea5e9; border-color: #0ea5e9; display: inline-flex; align-items: center; gap: 8px; text-decoration: none;">
                ...
                <table class="admin-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="color: #64748b; max-width: 300px; white-space: normal; word-break: break-word;">

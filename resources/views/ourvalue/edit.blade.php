    ...
    <div class="container" style="max-width: 800px; margin: 0 auto;">
        ...
        <div class="card">
            ...
            <div class="header-section" style="margin-bottom: 25px; border-bottom: 1px solid #e2e8f0; padding-bottom: 15px;">
                <h2 style="margin: 0;">Edit Our Value</h2>
            </div>
            ...
            <form action="{{ route('ourvalues.update', $ourvalue->id) }}" method="POST">
                ...
                <div class="form-group" style="margin-bottom: 20px; display: flex; flex-direction: column; gap: 8px;">
                    ...
                    <input type="text" name="judul" value="{{ old('judul', $ourvalue->judul) }}" placeholder="Masukkan judul..." style="padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; outline: none; transition: border-color 0.2s;" onfocus="this.style.borderColor='#0ea5e9'" onblur="this.style.borderColor='#cbd5e1'">
                </div>

                <!-- Input Deskripsi -->
                <div class="form-group" style="margin-bottom: 20px; display: flex; flex-direction: column; gap: 8px;">
                    <label style="font-weight: 600; color: #334155; font-size: 14px;">Deskripsi</label>
                    <textarea name="deskripsi" rows="5" placeholder="Tuliskan deskripsi lengkap di sini..." style="padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; outline: none; resize: vertical; transition: border-color 0.2s;" onfocus="this.style.borderColor='#0ea5e9'" onblur="this.style.borderColor='#cbd5e1'">{{ old('deskripsi', $ourvalue->deskripsi) }}</textarea>
                </div>
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 30px;">
                    ...
                    <div class="form-group" style="display: flex; flex-direction: column; gap: 8px;">
                        ...
                        <input type="number" name="urutan" value="{{ old('urutan', $ourvalue->urutan) }}" placeholder="Contoh: 1" style="padding: 10px 14px; border: 1px solid #cbd5e1; border-radius: 6px; font-size: 14px; outline: none;" onfocus="this.style.borderColor='#0ea5e9'" onblur="this.style.borderColor='#cbd5e1'">
                    </div>
